...
#ifndef CommonThreads__H__
#define CommonThreads__H__
...
/**
 * Yarp thread used to set new position for a robot part using the passed positions and velocity.
 ...
 * The velocity can be either a single value for all the jointss or can be a vector specifying the velocity
 * to employ for each joint.
 */
