...
void serialize(Archive & ar, std::tuple<int,int> & g, const unsigned int version)
{
    ar & std::get<0>(g);
    ar & std::get<1>(g);
}
...
template<class Archive>
void serialize(Archive & ar, std::tuple<int, int, int> & g, const unsigned int version)
{
    ar & std::get<0>(g);
    ar & std::get<1>(g);
    ar & std::get<2>(g);
...
template<class Archive>
void serialize(Archive & ar, std::tuple<int, int, int, int, int> & g, const unsigned int version)
{
    ar & std::get<0>(g);
    ar & std::get<1>(g);
    ar & std::get<2>(g);
